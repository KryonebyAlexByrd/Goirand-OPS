...
async function check() {
  const res = await fetch(`${url}/rest/v1/registro_trabajo?select=id,tipo_trabajo,fase,es_finalizado,cantidad,proyecto_nombre,created_date&order=created_date.desc&limit=5`, {
